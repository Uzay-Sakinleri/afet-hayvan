...
async function getAnimal(animalid) {
    ...
    const pool = new Pool();
    const animal = {animalId: animalid, name: '', appearance: {appearanceId: 0, furColor: {furColorId: 0, name: ''},
    eyeColor: {eyeColorId: 0, name: ''}, accessory: ''}, breed: {breedId: 0, brName: ''}, specie: {specieId: 0, speName: ''}, imagePath: ''};
...
async function getPost(postid) {
    ...
    const userid = 0;
    const animalid = 0;
    const post = {postID: postid, name:'',user:{},animal:{}, createdAt: 0, completedAt: null, status:''};
    ...
    post.animal = getAnimal(animalid)
    return post;
}
